...
| <a name="input_s3_bucket_encryption_type"></a> [s3\_bucket\_encryption\_type](#input\_s3\_bucket\_encryption\_type) | Encryption for S3 bucket , options :<br> 	SSE-S3 - AES256<br>SSE-KM - aws:kms | `string` | `"SSE-S3"` | no |
