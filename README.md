...
| <a name="input_acm_lifecycle"></a> [acm\_lifecycle](#input\_acm\_lifecycle) | Enables AWS ACM lifecycle management, automatically removing certificates attached to CloudFront distributions when no longer needed and before destroying it. | `bool` | `false` | no |
